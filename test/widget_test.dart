...
void main() {
  testWidgets('ForesightApp builds Home with the wordmark and injected tiles',
    ...
    // Story 3.6: ForesightApp now requires the root SettingsController. Seed it
    // over mocked prefs (never a device store).
    ...
    await tester.pumpWidget(
        ForesightApp(pokemon: fakeDex, chart: chart, settings: settings));
    await tester.pump();
